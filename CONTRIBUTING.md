# Contributing to the BLang library

First off, thank you for considering contributing to the BLang library! 
...
1. **Check if the bug has already been reported** by searching the [issues](https://github.com/CLEARSY/BLang/issues) page.
...
2. **Identify issue**: Every contribution should correspond to a project [issue](https://github.com/CLEARSY/BLang/issues). So make sure an issue corresponding to the contribution exists.
